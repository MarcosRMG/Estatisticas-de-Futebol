...
def indicadores(dados: pd.DataFrame, ultimos_jogos=5):
    ...
    #Passes
    media_passes_certos = round(dados['passes_certos_%'][:ultimos_jogos].mean())
    desvio_padrao_passes_certos = round(dados['passes_certos_%'][:ultimos_jogos].std())
    #Chutes
    media_chutes_gol = round(dados['chutes_ao_gol_%'][:ultimos_jogos].mean())
    desvio_padrao_chutes_gol = round(dados['chutes_ao_gol_%'][:ultimos_jogos].std())
    media_gol_chutes_gol = round(dados['gols_por_chute_ao_gol_%'][:ultimos_jogos].mean())
    desvio_padrao_gol_chutes_gol = round(dados['gols_por_chute_ao_gol_%'][:ultimos_jogos].std())
